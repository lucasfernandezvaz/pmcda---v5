...
const initialEditais: Edital[] = [
  ...
  {
    id: 4,
    title: "Edital GOT - Operações Táticas",
    description: "Seleção para o Grupo de Operações Táticas. Exige experiência prévia e testes físicos rigorosos.",
    unit: "GOT",
  ...
  {
    id: 5,
    title: "Recrutamento PERÍCIA - Investigação Criminal",
    description: "Processo para ingresso na Perícia Criminal. Requisitos técnicos específicos.",
    unit: "PERÍCIA",
  ...
  {
    id: 6,
    title: "Seleção GIC - Investigações Criminais",
    description: "Edital para o Grupo de Investigações Criminais. Foco em inteligência policial.",
    unit: "GIC",
      ...
      <section className="bg-gradient-to-r from-black via-blue-900 to-black py-16">
        <div className="container mx-auto px-4 text-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="text-yellow-500">Editais</span> PMCAP
          </h1>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Processos seletivos e oportunidades de ingresso nas unidades especializadas
          </p>
        </div>
      </section>
